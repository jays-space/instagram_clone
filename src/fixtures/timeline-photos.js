export default [
  {
    ...
    comments: [
      ...
      {
        displayName: "dali",
        comment: "Love this place, looks like my animal farm! Again",
      },
      {
        displayName: "orwell",
        comment: "Would you mind if I used this picture? Again",
      },
      {
        displayName: "dali",
        comment: "Love this place, looks like my animal farm! ...And again",
      },
      {
        displayName: "orwell",
        comment: "Would you mind if I used this picture? ...And again",
      },
    ],
    ...
    likes: ["igPUAuFMzmO7979l3nFdctDR3Ph2"],
    userId: "2",
